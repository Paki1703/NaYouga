...
<template>
  <div class="mx-auto max-w-7xl px-4 py-10 lg:px-8">
    ...
    <template v-if="content">
      <GlassCard class="mt-12">
        <div class="p-6 space-y-6 leading-relaxed text-gray-400" v-html="content.history"></div>
      </GlassCard>

      <GlassCard class="mt-8">
        <div class="p-6 space-y-6 leading-relaxed text-gray-400" v-html="content.description"></div>
      </GlassCard>

      <h2 class="section-title mt-16">Особенности</h2>
